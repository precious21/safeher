...
@Repository
public class RequestStatusImpl implements RequestStatusRepository{

	private static final String KEY = "RequestStatus";
	...
	@Autowired
	private RequestStatusImpl(RedisTemplate redisTemplate) {
